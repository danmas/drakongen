...
public String to_string(String sql_str) throws Exception {
	try {
		...
		while (matcher.find()) {
			matcher.appendReplacement(sb, getParameter(indx++));
		}
		matcher.appendTail(sb);
		return sb.toString();
	} catch (Exception ex) {
		String str = "Ошибка в PreparedStatementHelper.to_string() " +ex.getMessage();
