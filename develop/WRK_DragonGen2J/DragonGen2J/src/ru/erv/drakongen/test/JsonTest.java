...
//    	String s =" {\"type\":\"OS_SCRIPT\",\"scr@ipt\":\"ping -n 3 http-proxy.srv.rdtex.ru\""
//    			+ ",\"description\":\"Тест выполнения скрипта ОС\",\"max_duration_in_sec\":\"5\""
//    			+ ",\"launch_period_in_sec\":\"5\"}";
    	
    	String s ="{\"type\":\"TT_SSH_PWD\",\"script\":\"git config --global core.autocrlf false"
    			+ "    			git config --global core.safecrlf false"
    			+ "   		git config --global user.name Roman"
    			+ "    		git config --global user.email Roman.Eremeev@gmail.com\""
    			+ "    		,\"host\":\"carlhost\",\"port\":\"22\""
    			+ "    		,\"user\":\"Dima\",\"password\":\"1\""
    			+ "    		,\"description\":\"Тест выполнения скрипта ОС\""
    			+ "    		,\"max_duration_in_sec\":\"5\""
    			+ "    		,\"launch_period_in_sec\":\"5\"}";    	
    	try {
    ...
    public static void main(String[] args) { 
        /*
         * {"type":"REPLACE",
         * "dataset":[{"string":"%PASSWORD%","replace":"1"},{"%SERVER%","carlhost"}]
         * }
         */
        String s =  "{\"type\":\"SUBST\""
        		+ ",\"replacements\":["
        		+ "{\"what\":\"%PASSWORD%\",\"to\":\"1\"}"
        		+ ",{\"what\":\"%SERVER%\",\"to\":\"carlhost\"}]}";
        try {
            JSONObject genreJsonObject = (JSONObject) JSONValue.parseWithException(s);
            // get the title
            System.out.println(genreJsonObject.get("type"));
            // get the data
