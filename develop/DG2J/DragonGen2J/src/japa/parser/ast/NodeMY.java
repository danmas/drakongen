...
import ru.erv.drakongen.j2dg.japa.DumpVisitorGml;
...
public abstract class NodeMY {
    ...
    public NodeMY(int beginLine, int beginColumn, int endLine, int endColumn) {
    ...
    public final String toGraphml() {
        DumpVisitorGml visitor = new DumpVisitorGml();
        
        //-- строим деревья NodeDG
        accept(visitor, null);
        
        //-- utythbv 
        return visitor.getGmlSource();
    }
    ...
    public final String getControlString() {
        ...
        accept(visitor, null);
        return visitor.getControlString();
    }
    ...
    //    return EqualsVisitor.equals(this, (NodeMY) obj);
    //}
